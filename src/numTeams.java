...
//        Arrays.sort(rating);
        for (int a = 0; a < n - 2; a++) {
            ...
            for (int b = a + 1; b < n - 1; b++) {
                if (rating[a] > rating[b]) continue;
                for (int c = b + 1; c < n; c++) {
                    if (rating[b] > rating[c]) continue;
